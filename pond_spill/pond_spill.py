...
def main():
    ...
    for i in range(1, minutes):
        poll[i] = [pond1(i), pond2(i), pond3(i)]
    for i in range(60, minutes, 60):
        if i < minutes:
            print('Minutes: ', i)
        else:
            print('Minutes [FINAL]: ', i)
        print('Pond 1: ', pond1(i), ' Pond 2: ', pond2(i), ' Pond 3: ', pond3(i))
    if minutes <= 1440:
        print('Minutes: 1440')
...
def pond1(t):
    ...
    poll1 = inflow3 - outflow2 + pollutantLeak(t)
